    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        <div className="inline-flex w-full h-[6vh] items-center justify-center rounded-xl bg-blue-100 p-1">
          <button
            className={`inline-flex items-center justify-center whitespace-nowrap rounded-xl w-[48vw] h-[5vh] text-sm font-medium transition-all focus:outline-none ${
              activeTab === "admin"
      ...
      {activeTab === "super-admin" && (
        <div className="space-y-4 h-[130vh]">
